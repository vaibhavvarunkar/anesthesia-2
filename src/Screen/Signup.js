...
const Signup = () => {
    ...
    const signUp=()=>{
        ...
        fetch(`http://ec2-18-189-0-11.us-east-2.compute.amazonaws.com/api/signup?email=${email}&first_name=${firstName}l&last_name=${lastName}&mobile_number=${phoneNumber}&password=${password}&confirm_password=${confirmPassword}&device_type=Android&device_token=123` ,{
            method: 'POST',
            headers: { 
