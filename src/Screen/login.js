...
function Login() {
    ...
    const responseGoogle = (response) => {
       ...
       fetch(`http://ec2-18-189-0-11.us-east-2.compute.amazonaws.com/api/login-with-social?social_id=${response.profileObj.googleId}&social_type=Google&device_token=123456789&device_type=Android` ,{
            method: 'POST',
      ...
      const loginUser=()=>{
        ...
        if(email===""){
            ...
            fetch(`http://ec2-18-189-0-11.us-east-2.compute.amazonaws.com/api/login?email=${email}&password=${password}&device_token=123&device_type=Android` ,{
        method: 'POST',
        ...
        <div class="container">
            <div class="row justify-content-center ">
                <div class="col-md-5 whtbx">
                    ...
                    <p class="ORs text-uppercase">OR Signup Using</p>
